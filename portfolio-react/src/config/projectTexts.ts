...
export interface ProjectText {
  ...
  imagePosition?: string; // CSS object-position for the tile image (e.g. '55% center')
}
...
export const PROJECT_TEXTS: ProjectText[] = [
  ...
  },
  {
    ...
    stickerImage: "assets/images/sticker3.png",
    imagePosition: "calc(60% + 20px) center"
  },
  {
    id: 16,
    ...
    bodyText: `
      <h3>Challenges</h3>
      <p>Integrating artistic elements with technical requirements while keeping the form intuitive and the brewing process approachable.</p>
      <div class="process-image-slider">
        <img src="assets/images/coffee/cofchal1.webp" alt="Coffee Machine - challenge 1" class="process-image-inline" />
        <img src="assets/images/coffee/coffeechal2.webp" alt="Coffee Machine - challenge 2" class="process-image-inline" />
      </div>

      <h3>Solutions</h3>
      <p>Collaborated with engineers and material specialists to balance aesthetic ambition with functional precision, resulting in a cohesive and production-ready design.</p>
      <div class="process-image-slider">
        <img src="assets/images/coffee/cofsol1.webp" alt="Coffee Machine - solution 1" class="process-image-inline" />
        <img src="assets/images/coffee/cofsol2.webp" alt="Coffee Machine - solution 2" class="process-image-inline" />
      </div>
    `,
    processImages: [
      "assets/images/coffee/cofchal1.webp",
